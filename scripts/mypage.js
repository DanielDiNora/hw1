function loadProfile(event){
    ...
    url2=splitUrl[0]+'//'+splitUrl[2]+'/'+splitUrl[3]+'/fetch_profile.php'; 
...
function onSelectFile(event){
    ...
    if(file[0].size<5000000){
        ...
        const url=window.location.href;
        var splitUrl = url.split('/');
        url2=splitUrl[0]+'//'+splitUrl[2]+'/'+splitUrl[3]+'/fetch_sendProfileImage.php'; 
        fetch(url2,{
            method : 'post',
            body: form
...
function loadCartellaClinica(event){
    ...
    const url=window.location.href;
    var splitUrl = url.split('/');
    url2=splitUrl[0]+'//'+splitUrl[2]+'/'+splitUrl[3]+'/fetch_cartella.php'; 
...
function loadInfoReaprto(event){
    const url=window.location.href;
    var splitUrl = url.split('/');
    url2=splitUrl[0]+'//'+splitUrl[2]+'/'+splitUrl[3]+'/fetch_reparto.php'; 
...
function showterapia(event){
    ...
    const url=window.location.href;
    var splitUrl = url.split('/');
    url2=splitUrl[0]+'//'+splitUrl[2]+'/'+splitUrl[3]+'/fetch_terapia.php'; 
...
function sendRicovero(event){
    ...
    if(nome.value==''||cognome.value==''||email.value==''||cf.value==''||data.value==''||citta.value==''||ananmesi.value=='' ){
        ...
        if(controllo){
            ...
            const url=window.location.href;
            var splitUrl = url.split('/');
            url2=splitUrl[0]+'//'+splitUrl[2]+'/'+splitUrl[3]+'/fetch_ricovero.php'; 
            fetch(url2,
            {
                method: 'post',
...
function parcheggio(event){
    ...
    const url=window.location.href;
    var splitUrl = url.split('/');
    url2=splitUrl[0]+'//'+splitUrl[2]+'/'+splitUrl[3]+'/fetch_parcheggio.php'; 
...
function prenota(event){
    ...
    const url=window.location.href;
    var splitUrl = url.split('/');
    url2=splitUrl[0]+'//'+splitUrl[2]+'/'+splitUrl[3]+'/fetch_prenotaParcheggio.php'; 
    fetch(url2,{
        method : 'post',
        body: JSON.stringify(dati)
