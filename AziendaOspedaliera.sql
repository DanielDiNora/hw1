...
(20, 'dnrdnl98m11d423b', '2021-05-23', NULL, 'NULL', '123', 1);
DELIMITER $$
...
CREATE TABLE `farmaci_cartella` (
  `id_cartella` int(11) NOT NULL,
  `nome_farmaco` varchar(16) NOT NULL,
  `quantita_giornaliera` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO `farmaci_cartella` (`id_cartella`, `nome_farmaco`, `quantita_giornaliera`) VALUES
(1, 'azactam', 2),
(1, 'elferelgan', 1),
(2, 'azactam', 2),
(3, 'nimesulide', 1),
...
('anddnl98m11d423b', 'Andrea', 'Dadada98', 'danix9876@gmail.com', 'NULL', 'Di Nora', '1998-08-11', 'Calta'),
...
('dnenmi98m11d423b', 'Noemi', 'Dadada98', 'danix9876@gmail.com', 'NULL', 'Di Nora', '1998-08-11', 'Calta'),
('dnrdnl98m11d423b', 'daniel', 'Dadada98', 'danix9876@gmail.com', './imageProfile/dnrdnl98m11d423b.jpeg', 'di nora', '1998-08-11', 'caltagirone'),
...
('hrrptt83m80d423b', 'harry', NULL, NULL, NULL, 'potter', '1980-12-31', 'catania'),
...
('RPF56CFQ2QINA932', 'Chelsea', NULL, NULL, NULL, 'Kerr', '1997-06-24', 'agrigento'),
('rssmro70m11d423b', 'mario', 'Dadada98', 'danix9876@gmail.com', './imageProfile/rssmro70m11d423b.jpeg', 'rossi', '1970-06-06', 'milano'),
...
(1, 'endocrinologia', 'GARIBALDI NESIMA', 4, 29, 30, 1, 1, 7),
...
ALTER TABLE `cartella_clinica`
  MODIFY `id_cartella` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
ALTER TABLE `farmaci_cartella`
  ADD CONSTRAINT `farmaci_cartella_ibfk_1` FOREIGN KEY (`id_cartella`) REFERENCES `cartella_clinica` (`id_cartella`),
  ADD CONSTRAINT `farmaci_cartella_ibfk_2` FOREIGN KEY (`nome_farmaco`) REFERENCES `farmaco` (`nome`);
